...
joblib.dump(best_model, '../trained_models/gender_model.pkl')
joblib.dump(scaler, '../preprocessing/gender_scaler.pkl')
joblib.dump(feature_cols, '../preprocessing/gender_features.pkl')
...
joblib.dump(encoders, '../preprocessing/gender_encoders.pkl')